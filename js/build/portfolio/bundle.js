...
},{"./models/ProjectsCollection":2,"jquery":3,"routely-js":4,"underscore":5}],2:[function(require,module,exports){
var $ = require("jquery");
module.exports = {
		fetch: function () {
			var dfd = $.Deferred();
...
(function (name, definition) {
	...
	function routely () {
		this.routes = [];
		window.onload = RouteHandler.bind(this);
		window.onhashchange = RouteHandler.bind(this);
	}
	...
	function RouteHandler(evt) {
		...
		try {
			...
			if (this.routes[_route] !== undefined) {
				this.routes[_route].controller.call();
			} 
			// check for route with params
			else {
				for (var r in this.routes) {
					if(r !== '/' && this.routes[r].getRegExp().test(_route)) {
						var args = this._getRouteParams(this.routes[r].getRegExp(), _route);
						this.routes[r].controller.apply(this, args);
					}
				}
			}
		} catch (err) {
